...
class MinMaxSketchTest extends QueryTest with HyperspaceSuite {
  ...
  test("covertPredicate converts EqualTo(<struct field access>, <lit>).") {
  ...
  test("covertPredicate converts EqualTo(<nested struct field access>, <lit>).") {
  ...
  test("covertPredicate converts LessThan.") {
    ...
    val result = sketch.convertPredicate(
      ...
      exprIdColMap,
      Seq(AttributeReference("A", IntegerType)(ExpressionUtils.nullExprId)))
    val expected = Some(And(IsNotNull(sketchValues(0)), LessThan(sketchValues(0), Literal(42))))
    assert(result === expected)
  }
  ...
  test("covertPredicate converts LessThanOrEqual.") {
    ...
    val result = sketch.convertPredicate(
      ...
      Seq(AttributeReference("A", IntegerType)(ExpressionUtils.nullExprId)))
    val expected =
      Some(And(IsNotNull(sketchValues(0)), LessThanOrEqual(sketchValues(0), Literal(42))))
    assert(result === expected)
  }
  ...
  test("covertPredicate converts GreaterThan.") {
    ...
    val result = sketch.convertPredicate(
      ...
      Seq(AttributeReference("A", IntegerType)(ExpressionUtils.nullExprId)))
    val expected =
      Some(And(IsNotNull(sketchValues(0)), GreaterThan(sketchValues(1), Literal(42))))
    assert(result === expected)
  }
  ...
  test("covertPredicate converts GreaterThanOrEqual.") {
    ...
    val result = sketch.convertPredicate(
      ...
      Seq(AttributeReference("A", IntegerType)(ExpressionUtils.nullExprId)))
    val expected =
      Some(And(IsNotNull(sketchValues(0)), GreaterThanOrEqual(sketchValues(1), Literal(42))))
    assert(result === expected)
  }
